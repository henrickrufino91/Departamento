...
public class DepartamentoController {
	...
	public ModelAndView novo(@Valid Departamento departamento) {
		...
		try {
			...
			ModelAndView mv = new ModelAndView("redirect:/novoDepartamento");
    ...
    public ModelAndView remover(@RequestParam Integer codigo){
		...
		ModelAndView mv = new ModelAndView("redirect:/listarDepartamentos");
    ...
    public ModelAndView listar(){
        ...
        ModelAndView mv = new ModelAndView("listarDepartamentos");
